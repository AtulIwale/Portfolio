# Analysis and ML — Construction Payroll

Data version AEC-DEMO-2026.1; 5,000 primary rows; 5,000 details and 5,000 capture events. Reporting date 2025-03-01.

## Descriptive results

Calculated net pay: 276,730,321.44. Median 54,032.33; 90th percentile 86,837.39. All statuses are included: these record totals are not recognized revenue or posted-ledger balances. Monetary examples use INR.

| Status | Records | Value |
|---|---:|---:|
| Approved | 340 | 18,627,484.12 |
| Calculated | 320 | 17,542,499.23 |
| Held for attendance | 3,719 | 206,576,973.07 |
| Paid | 307 | 16,125,227.48 |
| Under review | 314 | 17,858,137.54 |

## Model

Target: A payroll line needs correction before release. Creation-time inputs: overtime_hours, allowance, manual_adjustments, input_exceptions. Decision tree: maximum depth 4; minimum leaf 60 training rows.
...
| recall | 0.2909 |
| brier | 0.2078 |
| baselineBrier | 0.2264 |
| baselineAccuracy | 0.654 |
| testEventRate | 0.346 |
| confusionMatrix | [[831, 150], [368, 151]] |
